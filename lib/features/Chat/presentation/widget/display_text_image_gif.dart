    ...
    return type == MessageEnum.text
        ? Text(
            ...
            style: TextStyle(
                ...
                fontSize: 13,
                color: check == "me" ? Colors.white : Colors.black,
                ...
                child: ClipRRect(
                  ...
                  child: Material(
                    ...
                    child: VoiceMessageView(
                      circlesColor: Colors.black.withOpacity(0.2),
                      activeSliderColor:
                          check == "me" ? Colors.white : Colors.black,
                      backgroundColor: check == "me"
                          ? Color(int.parse("0xFF$colorMe"))
                          : Color(int.parse("0xFF$colorSender")),
              ...
              child: Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      (widget.isProfilePhoto == true &&
                              widget.uidUser == auth.currentUser!.uid)
                          ? IconButton(
                              iconSize: 30,
                              onPressed: () {
                                if (mounted) {
                                  ref
                                      ...
                                      .deletePhotProfile(
                                          widget.uidUser, widget.filename);
                                }
                                Navigator.pop(context);
                              },
                              icon: Icon(
