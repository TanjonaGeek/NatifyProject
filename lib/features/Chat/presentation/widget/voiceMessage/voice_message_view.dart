...
import 'package:natify/features/Chat/presentation/widget/voiceMessage/helpers/play_status.dart';
import 'package:natify/features/Chat/presentation/widget/voiceMessage/helpers/utils.dart';
import 'package:natify/features/Chat/presentation/widget/voiceMessage/voice_controller.dart';
import 'package:natify/features/Chat/presentation/widget/voiceMessage/widgets/noises.dart';
import 'package:natify/features/Chat/presentation/widget/voiceMessage/widgets/play_pause_button.dart';
...
class VoiceMessageView extends StatelessWidget {
  const VoiceMessageView({
    ...
    this.activeSliderColor = Colors.grey,
    this.notActiveSliderColor,
    this.circlesColor = newColorBlueElevate,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.only(top: 1, bottom: 3, left: 5, right: 5),
                    ...
                    Flexible(
                      child: Text(
                        ...
                        overflow: TextOverflow
                            .ellipsis, // Tronque le texte s'il est trop long
                      ),
                    ),
                  ],
                ),
