...
class _FilterPageState extends ConsumerState<FilterPage> {
  ...
  Future<void> loadFilterPreferences() async {
    ...
    String? loadedFlag = prefs.getString('flag');
    String? loadedSexe = prefs.getString('sexe');
    String? loadedNationalite = prefs.getString('nationalite');
    String? loadedPays = prefs.getString('pays');
    ...
    RangeValues loadedRangeOfageDebutAndFin = rangeString != null
        ...
        : RangeValues(14, 90); // Valeurs par défaut
    ...
    setState(() {
      ...
      pays = loadedPays ?? '';
      age = loadedRangeOfageDebutAndFin;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "${age.start.toInt()} $a ${age.end.toInt()} $ans",
                        style: TextStyle(
